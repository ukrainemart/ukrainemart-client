...
<template>
  <div
    :class="
      cn(
        'fixed inset-x-0 -top-full z-40 h-fit rounded-b-[10px] bg-white px-5 py-[25px] text-black transition-all delay-0 duration-[400ms] ease-linear md:top-[-400px] md:px-10 md:py-[30px] xl:hidden',
        {
